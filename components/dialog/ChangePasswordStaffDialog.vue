...
const emit = defineEmits<{
    ...
    (e: 'closed'): void
    (e: 'save', data: ChangePasswordStaffType): void
}>()
...
watch(
    ...
    (val) => {
        if (val) {
            ruleForm.user_id = val !== null ? String(val) : null
        }
    },
    { immediate: true }
)
...
const ruleForm = reactive<ChangePasswordStaffType>({
    user_id: null,
    new_password: null,
    ...
    <el-dialog v-model="visible" width="350" @close="handleClose" style="padding: 0px;">
        ...
        <template #footer>
            <div class="flex justify-end p-2">
                ...
                <el-button @click="submitForm(ruleFormRef)" type="primary" :icon="Checked" :loading="props.loading"
                    :disabled="props.loading" plain>
